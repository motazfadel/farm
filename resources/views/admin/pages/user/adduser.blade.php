                                ...
                                <div class="p-3">
                                    ...
                                    <form method="POST" action="{{ route('newuser') }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="الإيميل">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="date_birth" type="date" class="form-control @error('date_birth') is-invalid @enderror" name="date_birth" value="{{ old('date_birth') }}" required autocomplete="date_birth" autofocus placeholder="تاريخ الميلاد">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="date_employment" type="date" class="form-control @error('date_employment') is-invalid @enderror" name="date_employment" value="{{ old('date_employment') }}" required autocomplete="date_employment" autofocus placeholder="تاريخ التوظيف">
